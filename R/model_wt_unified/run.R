# =============================================================================
# R/model_wt_unified/run.R
# Entry point for WT Unified model (WT_Clean and WT_Biased merged into WT)
# =============================================================================

cat("=============================================================================\n")
cat("DPYD Arm-Based NMA: WT Unified Model\n")
cat("=============================================================================\n\n")
...
# Key difference: aggregate_wt = TRUE merges WT_Clean and WT_Biased arms
...
cat("\n=============================================================================\n")
cat("WT Unified Model Analysis Complete\n")
cat("=============================================================================\n")
